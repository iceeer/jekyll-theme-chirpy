...
test() {
  bundle exec htmlproofer  --url-ignore "/${o}/,/${e}/" --disable-external --allow-missing-href --empty-alt-ignore --allow_hash_href  --alt-ignore --ignore-empty-mailto --extension .js    "$SITE_DIR"
}
