...
test() {
  bundle exec htmlproofer --only-4xx --disable-external --allow-missing-href --empty-alt-ignore --allow_hash_href  --alt-ignore --ignore-empty-mailto --extension .htm    "$SITE_DIR"
}
