...
test() {
  bundle exec htmlproofer --checks "ScriptCheck" --disable-external --allow-missing-href --empty-alt-ignore --allow_hash_href  --alt-ignore --ignore-empty-mailto --extension .js    "$SITE_DIR"
}
